"""Konfiguracja środowiska Alembic (async).

Connection string pochodzi wyłącznie z `app.core.config.Settings`
(pydantic-settings, `.env` / zmienne środowiskowe) — nigdy nie hardkoduj
...
# Connection string wyłącznie z ustawień aplikacji (nie z alembic.ini).
